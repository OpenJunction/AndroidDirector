...
public final class IntentLauncher {
  ...
  public static boolean launch(Context context, Intent intent, String packageName, String appName) {
	  return launch(context,
			  intent,
			  packageName,
  ...
  /**
   * Launches an intent. Returns true if the intent launched successfully.
   * 
   *
